...
if makefolder and isfolder and not isfolder("Snow Hubv2") then
    ...
    makefolder("Snow Hubv2/Extra")
end


if not isfile("/Snow Hubv2/Extra/Quotes_For_SnowHubv2.txt") then 
    writefile("/Snow Hubv2/Extra/Quotes_For_SnowHubv2.txt", req({ Url = "https://raw.githubusercontent.com/Kitzoon/Rogue-Hub/main/Extra/Quotes.ROGUEHUB" }).Body);
end
...
if response.StatusCode ~= 404 then
    ...
    loadstring(game:HttpGet("https://pastebin.com/raw/pmGT8gpe"))()
    ...
    loadstring(game:HttpGet("https://pastebin.com/raw/pmGT8gpe"))()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/SnowHack-Snomn/SnowHubv2/main/Games/Universal.lua"))()
    return
end
